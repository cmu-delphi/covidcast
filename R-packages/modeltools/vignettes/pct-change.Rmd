...
length. As shown here, this calculation can be done with the
[`pct_change()`](https://cmu-delphi.github.io/covidcast/modeltoolsR/reference/pct_change.html)
function.
...
[`vignettes/pct-change.Rmd`](pct-change.Rmd) 
...
The `pct_change()` function exploits the functionality of 
[`slide_by_geo`](https://cmu-delphi.github.io/covidcast/covidcastR/reference/slide_by_geo.html)
to slide this calculation over a
...
The percentage change calculation follows via the following 
