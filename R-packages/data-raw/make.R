...
county_census$FIPS = county_census$STATE * 1000 + county_census$COUNTY
save(county_census, file = "../covidcast/data/county_census.rda")
...
county_geo$FIPS = as.numeric(as.character(county_geo$FIPS))
county_geo$TIME_ZONE = NULL
county_geo$geometry = NULL
county_geo = data.frame(county_geo)
save(county_geo, file = "../covidcast/data/county_geo.rda")
