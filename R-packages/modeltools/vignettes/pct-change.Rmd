...
case_rates %>% 
  ...
  head(21) %>%
  kable(format = "html", digits = 3, caption = paste("U.S. COVID-19 case rates (with",
...
```{r, message = F, warning = F, fig.width = 8, fig.height = 4, fig.retina = 2, dpi = 85}
library(ggplot2)
library(gridExtra)
...
case_rates %>%
  ...
  head(n = 7) %>%
  kable(format = "html", digits = 3, caption = paste("U.S. COVID-19 case rates (with",
                                                     "daily percentage change and",
                                                     "post-hoc 7-day trailing average)"))
```
...
```{r, message = F, warning = F, fig.width = 8, fig.height = 4.5, fig.retina = 2, dpi = 85}
library(tidyr)
