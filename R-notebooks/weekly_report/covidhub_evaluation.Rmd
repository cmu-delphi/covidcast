...
score_cards_state_tourney = score_cards_state
...
score_cards_county = score_cards_county %>% 
                    filter(forecaster %in% active_forecasters)
score_cards_county_tourney = score_cards_county
```
...
### States
```{r, fig.width = 10, fig.height = 10}
theta_state = pairwise_tournament(score_cards_state_tourney, var = "wis", aggr = 
...
### Counties
```{r, fig.width = 10, fig.height = 10}
theta_county = pairwise_tournament(score_cards_county_tourney, var = "wis", aggr = 
                              function(x) mean(x, trim = 0.01, na.rm = TRUE))
...
### State
```{r, fig.width = 10, fig.height = 10}
theta_state = pairwise_tournament(score_cards_state_tourney, var = "wis", aggr = Median)
...
### County
```{r, fig.width = 10, fig.height = 10}
theta_county = pairwise_tournament(score_cards_county_tourney, var = "wis", aggr = Median)
