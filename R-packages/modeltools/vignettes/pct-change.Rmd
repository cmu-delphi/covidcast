...
description: Compute percentage change of values over time.
...
case_rates <- pct_change(case_rates, n = 14, new_col = "pct_change")
...
case_rates <- case_rates %>%
  pct_change(n = 2, new_col = "pct_change_daily") %>%
  slide_by_geo(~ Mean(.x$pct_change_daily), n = 7, 
               new_col = "pct_change_daily_7dav")
