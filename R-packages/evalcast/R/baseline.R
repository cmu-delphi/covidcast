...
#' Baseline classification forecaster
#'
#' This serves as a template for a non-quantile forecaster.  
#' It's not intended to be a great forecaster.
#'
#' @param df a data frame of the format that is outputted by
#'   \code{\link[covidcast]{covidcast_signal}}.
#' @param forecast_date date on which forecasts will be made about some period
...
baseline_classification_forecaster <- function(df,
                                               forecast_date,
                                               signals,
                                               incidence_period = c("epiweek", "day"),
                                               ahead = 1,
