...
# Sampling volume
df_quidel_states = covidcast_signal("quidel", "covid_ag_raw_pct_positive", start_day = twenty_eight_days_ago, geo_type = "state")
...
ggplot(states_per_day, aes(x = time_value, y = n)) + 
  geom_line() + geom_point() + theme_bw() +
  labs(x = "Date", y = "Number of States",
       title = sprintf("Unique States: %i, mean per day: %i",
