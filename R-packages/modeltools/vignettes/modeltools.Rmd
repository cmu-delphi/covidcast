...
>**_Warning_: This package is not on CRAN! There is a CRAN package named 
`modeltools`, but it is entirely unrelated to this one. To add further 
confusion, `pkgdown` automatically populates a link to the CRAN package in the
sidebar of our `pkgdown` homepage. This is a mistake.**
