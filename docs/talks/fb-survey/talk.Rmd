...
footer: 'Get the slides at: cmu-delphi.github.io/covidcast/talks/fb-survey/'
output: 
  slidy_presentation:
    theme: cerulean
    highlight: tango
...
Next talks: medical claims data, forecast evaluation, etc.
...
<br>
Both are `r col("absolutely massive")`. But they are are very different:
...
- COVID testing (more coming soon!)
- mental health
- social contacts and behavior
- mask wearing (coming soon!)
- demographics

A [parallel, international effort](https://covidmap.umd.edu/) by the University of Maryland reaches 100+ countries 
...
We ask people to report on their own symptoms, and also on symptoms of those around them. You'd be surprised ... the latter appears to be a lot more valuable! 
...
Let's take a look at case counts in Miami-Dade, from June 1 to July 15, and compare it to rhe % CLI-in-community indicator based on our survey
