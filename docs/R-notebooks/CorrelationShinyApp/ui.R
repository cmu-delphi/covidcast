                  ...
                  navbarPage("",
                             tabPanel(icon("home"), 
                                      fluidRow(column(
                                        ...
                                        "Here is an example of a ", strong("weak correlation plot")," and of a ", strong("strong correlation plot"),". The response is JHU incidence proportion on Jun 30, 2020 for both plots. The weak signal is raw Facebook ILI 21 days before averaged over 7 days and the strong signal is smoothed Facebook community CLI 7 days before averaged over 3 days.",
                                        p(),
                                        tags$img(src="uncorr_ili_plot.png", width = 350, length = 350),
                                        tags$img(src="corr_commcli_plot.png", width = 350, length = 350),
                                        br(),br(),
                                        h4("Upload csv"),
                                        p(),
