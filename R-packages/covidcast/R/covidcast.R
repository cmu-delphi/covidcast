...
#'   are permitted to be vectors. The returned object is a list of
#'   `covidcast_signal` data frames, of length `N = max(length(data_source),
#'   length(signal))`. The first two arguments `data_source`, `signal` are
