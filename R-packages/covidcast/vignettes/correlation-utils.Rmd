...
```
A `covidcast_signal` dataframe with 550032 rows and 9 columns.
...
median number of geo_values per day : 3274
```
...
![plot of chunk unnamed-chunk-3](figures/corr-unnamed-chunk-3-1.png)
...
Here we set `dt_x = -10`. This means that `iprop_act` will be lagged by 10 days,
...
![plot of chunk unnamed-chunk-4](figures/corr-unnamed-chunk-4-1.png)
...
![plot of chunk unnamed-chunk-5](figures/corr-unnamed-chunk-5-1.png)
...
![plot of chunk unnamed-chunk-6](figures/corr-unnamed-chunk-6-1.png)
...
![plot of chunk unnamed-chunk-7](figures/corr-unnamed-chunk-7-1.png)
