...
#'
#' @param predictions_cards List of predictions cards, as created by [get_predictions()].
#' @param name_of_forecaster String indicating name of the forecaster.
#' @param response_data_source String indicating response data source. 
#' @param response_signal String indicating response signal.
